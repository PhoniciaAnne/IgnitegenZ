...
const eduCards = [
  { icon: '🎥', title: 'Live Lectures', color: '#5b21b6', desc: 'Weekly live sessions with industry experts, founders, and domain specialists. Ask questions in real time.' },
  { icon: '🏆', title: 'Certified Courses', color: '#7c3aed', desc: 'Complete structured learning paths and earn industry-recognized certifications to boost your profile.' },
  { icon: '⭐', title: 'Master Classes', color: '#a855f7', desc: 'Intensive deep-dive sessions led by serial entrepreneurs covering business model, fundraising, and scaling.' },
]
      ...
      <section className={styles.hero}>
        ...
        <div className={`container ${styles.heroContent}`}>
          ...
          <p className={styles.heroSubtitle}>
            IgnitegenZ is where ambitious student entrepreneurs transform bold ideas into real ventures — with mentorship, education, community, and funding access.
          </p>
      ...
      <section className={styles.ctaSection}>
        <div className="container">
          <div className={styles.ctaBox}>
            ...
            <p>Join hundreds of student entrepreneurs who are turning ideas into impact with IgnitegenZ.</p>
